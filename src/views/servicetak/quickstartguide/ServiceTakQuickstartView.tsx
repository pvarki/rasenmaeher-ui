      ...
      >
        <CardsContainer>
          <ServiceInfoCard
            ...
            details={<>Valitse käyttöönotto-ohje laitteesi mukaan. 
            <br/>
            <span>Helpoin tapa tehdä käyttöönotto on <strong>parin kanssa</strong> siten, että toinen taistelija näyttää ohjetta ja toinen tekee.</span>
            </>}
          ></ServiceInfoCard>
