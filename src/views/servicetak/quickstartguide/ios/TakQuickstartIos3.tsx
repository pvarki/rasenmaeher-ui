        ...
        <div className="flex justify-center items-center w-full">
          <CardsContainer>
            ...
            <GuideSection
              ...
              image2Classes="mx-auto pr-5 w-[240px] p-4"
              description3={<>
                Aukeaa Selaa-valikko. Etsi kansio, johon latasit viestiperustetiedostosi <strong>Nimi.zip</strong>.
              </>}
              image3Src={pic12}
              image3Classes="mx-auto pr-5 w-[240px] p-4"
              note3={<>Huomaa, että tässä vaiheessa sinulla tulee olla viestiperustetiedosto <em>Nimi.zip</em> ladattuna puhelimeesi.
                <br></br>
                <br></br>
                Mikäli et jo ladannut sitä, lataat viestiperustepakettisi Rasenmaeherin TAK-päävalikosta napista <em>Lataa viestiperusteesi</em>.</>}
            />
            <GuideSection
              number="5."
              ...
              imageSrc={pic20}
              imageClasses="mx-auto pr-5 w-[240px] p-4"
              description2={<>Palaa karttanäkymään ylhäältä vasemmalta paluunuolilla.</>}
              image2Src={pic43}
              image2Classes="mx-auto pr-5 w-[150px] p-4"
              description3={<>
                <small><em>Karttanäkymässä oikealla alhaalla tulee vihreä merkkivalo ja teksti CONNECTED.</em></small>
                <br></br>
