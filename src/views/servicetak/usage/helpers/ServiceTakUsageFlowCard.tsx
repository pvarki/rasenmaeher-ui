    ...
    <div className="w-full m-2 p-0">
      <UnfoldableCard
        ...
        description1={<>
                ...
                <li>Taistelija lähettää merkin <em>HQ-roolille.</em></li>
        ...
        description2={<>
                ...
                <li>Komentopaikka <em>käsittelee havainnon:</em> </li>
                <li>- eli varmentaa ja tulkitsee sen, lisäten tietoa</li>
                <li>Komentopaikka lähettää merkin <strong>Recon Feediin</strong></li>
                </small>
                </>}
        description3={<>
                <small>
