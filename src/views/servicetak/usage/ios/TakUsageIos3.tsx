...
import pic18 from "../../../../assets/takguides/itak/itakquickstart8.png";
  ...
  return (
    <div className="pb-32">
      ...
      >
        ...
        <NavigateButtons
          backUrl="/app/services/tak/usage/ios2"
          forwardUrl="/app/services/tak/usage/ios4"
        />
      </Layout>
    </div>
  );
