    ...
    <div className="pb-32">
      ...
      >
        ...
        <div className="flex justify-center items-center w-full">
          <CardsContainer>
            <GuideSection
              ...
              description2={<>
                Painamalla keltaisen lipun symbolia, avautuu <strong>Notifications</strong>-näkymä.
              </>}
              image2Src={pic17}
              image2Classes="mx-auto pr-5 w-[400px] p-4"
              description3={<>
                Komentopaikalla käsiteltäviä havaintoja ovat <strong>Map Markers</strong>-havainnot ja <strong>Quick Picit.</strong> 
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <strong>Esimerkki:</strong> <em>iTAK002.01.123045</em>: <br /><li>kuun 1. päivänä klo 12:30:45 luotu havainto käyttäjältä iTAK002.</li>
              </>}
            />
            <GuideSection
              number="2."
              description={<>
                Havainnot <strong>avataan ja käsitellään</strong> näin:<br></br>
                <ul>
              ...
              description2={<>
                Valitse ympyrävalikosta roskakorin oikealla puolella oleva Marker Details-kuvake. Aukeaa <strong>Marker Details</strong>-näkymä (alla kuvassa)
              </>}
              image2Src={pic19}
              ...
              description3={<>
                ...
                <li>Kirjaa tulkintasi ja muutokset <strong>Remarkseihin.</strong>
                <br/>
                <br/>
              ...
              note3={<>
                <br/>Kun kirjaat tulkintoja, muista erottaa johtopäätös alkuperäisestä kuvauksesta. Tee tämä merkinnällä <em>HQ JP: (arvio tai johtopäätös)</em>
                <br />
                <br />Muista myös TL JULK - käytä peitteistöä.
              </>}
            />
        <GuideSection
          number="3."
          description={<>
          Kun olet tehnyt johtopäätöksen, muuta havainnon tyyppiä (tuntematon, vih, oma, neutr) Marker Details-näkymässä kohdassa <strong>Type</strong>.
          </>}
          ...
          note={<>
          Huomioi TL JULK. Älä tuo käytössäsi olevaa yläjopon vihollistietoa tähän - käytä peitteitä.<br></br>
          </>}

          description2={<>
          <br/>Quick Pic-havainnot tulevat ilman tyyppiä - muuta vastaavasti niiden tyyppi arvion tai johtopäätöksen mukaiseksi.
          </>}
          ...
          Esimerkin (ks. kohta 1) ajoneuvohavainnossa vaihdetaan tyypiksi <em>Ground track--Equipment--Ground vehicle--Civilian--Multi passenger--Van</em>.
          </>}
        ...
        <GuideSection
          number="4."
          description={<>
          Jatka havainnon käsittelyä Marker Details-valikossa muuttamalla sen nimeä merkiksi siitä, että se on HQ:n käsittelemä.
          <br/>
          <br/>
          ...
          description2={<>
          Käsittelytoimenpiteet suoritettu - seuraavaksi päätökset jakamisesta.
          </>}
          note2={<>
          <br/>
          Muista ylläpitää kaikista lähteistä saatuja havaintoja tiedusteludiaariin.
          </>}        
        />
        <GuideSection
          number="5."
          description={<>
          Päätä, jaetaanko havainto omalle joukolle <strong>erityisen ilmoituksen</strong> kanssa, vai ilman erityistä ilmoitusta:
          <br/>
          <br/>
          <strong>Tee erityinen ilmoitus</strong>, eli lähetä merkin lisäksi viesti, sinulle käsketyn hälytystaulukon mukaan <em>heti ilmoitettavista asioista.</em>: 
          </>}
  
          note={<>
          Erityinen ilmoitus tehdään hälytystaulukossa käsketyin viestivälinein.<br/> <br/>
          </>}
          description2={<>
          Molemmissa tapauksissa lähetä havainto joukon <strong>Recon Feediin</strong>, jolloin kaikki tilaajat näkevät sen. <br></br>Tee niin painamalla <strong>Marker Details</strong>-valikossa kuvan mukaista <strong>Send</strong>-nappia.
          </>}
        ...
        <GuideSection
          number="6."
          description={<>
          Oikeaan reunaan aukeaa painamalla Send-nappia Marker Details-valikossa <strong>Send To</strong>-valikko.
          </>}
