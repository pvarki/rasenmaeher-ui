import { isRootContent, RootContent } from "./RootContent";
...
export function isTakDownloadModalContent(
  value: unknown,
): value is TakDownloadModalContent {
  return isRootContent(value) && value?.type === ContentType.TAK_DOWNLOAD_MODAL;
}
