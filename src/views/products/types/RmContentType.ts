...
export function isRmContentType(value: unknown): value is RmContentType {
  ...
  switch (value) {
    case RmContentType.LAYOUT:
      return true;
    case RmContentType.CARD:
      return true;
    case RmContentType.NAVIGATE_BUTTONS:
      return true;
    case RmContentType.STATUS_BAR:
      return true;
    case RmContentType.FOLDABLE_CARD:
      return true;
    case RmContentType.SERVICE_INFO_CARD:
      return true;
    case RmContentType.UNFOLDABLE_CARD:
      return true;
    case RmContentType.DROPDOWN_OS_SELECTOR:
      return true;
    case RmContentType.BUTTON:
      return true;
    case RmContentType.TAK_DOWNLOAD_MODAL:
      return true;
    case RmContentType.CARDS_CONTAINER:
      return true;
    case RmContentType.STEP:
      return true;
  }
  return false;
}

export function isRmContentTypeOrUndefined(
  value: unknown,
): value is RmContentType | undefined {
  return value === undefined || isRmContentType(value);
}

export function isRmContentTypeOrString(
  value: unknown,
): value is RmContentType | string {
