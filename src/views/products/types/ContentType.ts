...
export function isContentType(value: unknown): value is ContentType {
  ...
  switch (value) {
    ...
    case ContentType.CARD:
      return true;
    case ContentType.NAVIGATE_BUTTONS:
      return true;
    case ContentType.STATUS_BAR:
      return true;
    case ContentType.COMPONENT_CHILDREN:
      return true;
    case ContentType.CARDS_CONTAINER:
      return true;
    case ContentType.FOLDABLE_CARD:
      return true;
    case ContentType.SERVICE_INFO_CARD:
      return true;
    case ContentType.UNFOLDABLE_CARD:
      return true;
    case ContentType.TAK_DOWNLOAD_MODAL:
      return true;
    case ContentType.DROPDOWN_OS_SELECTOR:
      return true;
