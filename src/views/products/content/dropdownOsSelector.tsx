...
export const dropdownOsSelector: RendererCompiler<BaseContent> = (
  content: DropdownOsSelectorContent,
): CompiledRenderer => {
  return () => (
    <DropdownOsSelector
      initialOS={
        content?.initialOS ?? DOWNLOAD_OPTIONS_SERVICE.getSelectedOS() === "iOS"
          ? "iOS"
          : "Other"
      }
