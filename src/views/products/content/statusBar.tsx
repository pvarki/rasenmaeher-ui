...
function getStatusBarProps( value: StatusBarContent ) : (context : RendererContext) => StatusBarProps {
...
export const statusBar : RendererCompiler<BaseContent> = (content: StatusBarContent) : CompiledRenderer => {
