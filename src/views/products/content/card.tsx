...
import { CardContent, CardContentProps } from "../types/CardContent";

function getCardProps(
  value: CardContent,
): (context: RendererContext) => CardContentProps {
  const titleFn = ProductContentRenderer.compile(value?.title);
  const detailsFn =
    value?.details !== undefined
      ? ProductContentRenderer.compile(value?.details)
      : undefined;
