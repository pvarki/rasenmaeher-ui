...
import { LayoutContent, LayoutContentProps } from "../types/LayoutContent";
import { RendererCompiler } from "../../../libs/rune/types/RendererCompiler";

function getLayoutProps(
  value: LayoutContent,
): (context: RendererContext) => LayoutContentProps {
  ...
  return (context: RendererContext) => {
    return {
      ...
      ...(value?.navbarTitle !== undefined
        ? { navbarTitle: navBarTitleFn(context) }
        : {}),
