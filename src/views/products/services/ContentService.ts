...
const EMPTY_CONTENT_SERVICE: RuntimeContentService =
  RuntimeContentServiceImpl.create("__empty", []);
...
export class ContentService {
  ...
  private static _productContentServices: Map<string, RuntimeContentService> =
    new Map();
  ...
  private static async _loadAndSetProduct(name: string) {
    ...
    this._productContentServices.set(
      name,
      RuntimeContentServiceImpl.create(name, content),
    );
