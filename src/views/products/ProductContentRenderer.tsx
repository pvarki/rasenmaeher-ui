...
import { isArray, isArrayOf } from "./helpers/isArray";
...
import { isStatusBarContent, StatusBarContent } from "./types/StatusBarContent";
...
export class ProductContentRenderer {
  ...
  public static prepareClassName(
    ...
    return value
      .map((item: string): string => {
        if (
          item.startsWith(this.ComponentParamPrefix) &&
  ...
  public static prepareImgAlt(
    ...
    if (!value) return "";
    if (
      value.startsWith(this.ComponentParamPrefix) &&
      context?.componentContent &&
      context?.stateContent
    ) {
  ...
  public static render(
    ...
    if (isLayoutContent(content)) {
      return (
        <Layout {...this._getLayoutProps(content, context)}>
    ...
    if (isCardContent(content)) {
      return (
        <Card {...this._getCardProps(content, context)}>
          {this.render(content?.body, context)}
        </Card>
      );
    }
    ...
    if (content?.type === ContentType.COMPONENT_CHILDREN) {
      if (context.stateContent === undefined) {
        ...
        return (
          <CardView title={`${content?.type}`} message={"No parent found"} />
        );
      }
      if (isBaseParentContent(context.stateContent)) {
        return this.render(
          context.stateContent.body,
          context.createContextWithoutParent(),
        );
      }
      console.warn(
        `Warning! No body found for: ${content?.type}: `,
        context.stateContent,
      );
    ...
    if (isUnfoldableCardContent(content)) {
      return (
        <UnfoldableCard2
          ...
          steps={
            content.steps
              ? this.prepareSteps(content.steps ?? [], context)
              : undefined
          }
          content={
            content.content ? this.render(content.content, context) : undefined
          }
          styling={
            content?.classes
              ? this.prepareClassName(content?.classes ?? [], context)
              : undefined
          }
    ...
    if (isButtonContent(content)) {
      ...
      if (modal) {
        const item: RootContent | undefined =
          context.contentService.getItem(modal);
        ...
        return (
          <Button
            ...
            onClick={() => {
              console.warn(
                `Warning! The modal was unknown type: ${modal}: `,
                item,
              );
            }}
            styling={this.prepareClassName(content.classes, context)}
      ...
      console.warn(
        `Warning! Button did not have any action defined: `,
        content,
      );
      return (
        <Button
    ...
    if (isDropdownOsSelectorContent(content)) {
      return (
        <DropdownOsSelector
          initialOS={
            content?.initialOS ??
            DOWNLOAD_OPTIONS_SERVICE.getSelectedOS() === "iOS"
              ? "iOS"
              : "Other"
          }
          osOptions={content.options}
          onOSChange={(newOS: string) =>
            DOWNLOAD_OPTIONS_SERVICE.setSelectedOS(parseOperatingSystem(newOS))
          }
        />
      );
    }
    ...
    if (isBaseParentContent(content)) {
      if (content?.type === ContentType.DIV) {
        return (
          <div className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </div>
        );
      }
      ...
      if (content?.type === ContentType.SPAN) {
        return (
          <span className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </span>
        );
      }
      ...
      if (content?.type === ContentType.H1) {
        return (
          <h1 className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </h1>
        );
      }
      ...
      if (content?.type === ContentType.H2) {
        return (
          <h2 className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </h2>
        );
      }
      ...
      if (content?.type === ContentType.H3) {
        return (
          <h3 className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </h3>
        );
      }
      ...
      if (content?.type === ContentType.H4) {
        return (
          <h4 className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </h4>
        );
      }
      ...
      if (content?.type === ContentType.H5) {
        return (
          <h5 className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </h5>
        );
      }
      ...
      if (content?.type === ContentType.H6) {
        return (
          <h6 className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </h6>
        );
      }
      ...
      if (content?.type === ContentType.UL) {
        return (
          <ul className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </ul>
        );
      }
      ...
      if (content?.type === ContentType.LI) {
        return (
          <li className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </li>
        );
      }
      ...
      if (content?.type === ContentType.OL) {
        return (
          <ol className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </ol>
        );
      }
      ...
      if (content?.type === ContentType.PRE) {
        return (
          <pre className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </pre>
        );
      }
      ...
      if (content?.type === ContentType.TABLE) {
        return (
          <table className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </table>
        );
      }
      ...
      if (content?.type === ContentType.THEAD) {
        return (
          <thead className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </thead>
        );
      }
      ...
      if (content?.type === ContentType.TBODY) {
        return (
          <tbody className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </tbody>
        );
      }
      ...
      if (content?.type === ContentType.TFOOT) {
        return (
          <tfoot className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </tfoot>
        );
      }
      ...
      if (content?.type === ContentType.TR) {
        return (
          <tr className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </tr>
        );
      }
      ...
      if (content?.type === ContentType.TH) {
        return (
          <th className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </th>
        );
      }
      ...
      if (content?.type === ContentType.B) {
        return (
          <b className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </b>
        );
      }
      ...
      if (content?.type === ContentType.U) {
        return (
          <u className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </u>
        );
      }
      ...
      if (content?.type === ContentType.DEL) {
        return (
          <del className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </del>
        );
      }
      ...
      if (content?.type === ContentType.SUP) {
        return (
          <sup className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </sup>
        );
      }
      ...
      if (content?.type === ContentType.SUB) {
        return (
          <sub className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </sub>
        );
      }
      ...
      if (content?.type === ContentType.AUDIO) {
        return (
          <audio className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </audio>
        );
      }
      ...
      if (content?.type === ContentType.VIDEO) {
        return (
          <video className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </video>
        );
      }
      ...
      if (content?.type === ContentType.I) {
        return (
          <i className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </i>
        );
      }
      ...
      if (content?.type === ContentType.P) {
        return (
          <p className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </p>
        );
      }
      ...
      if (content?.type === ContentType.EM) {
        return (
          <em className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </em>
        );
      }
      ...
      if (content?.type === ContentType.HEADER) {
        return (
          <header className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </header>
        );
      }
      ...
      if (content?.type === ContentType.MAIN) {
        return (
          <main className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </main>
        );
      }
      ...
      if (content?.type === ContentType.NAV) {
        return (
          <nav className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </nav>
        );
      }
      ...
      if (content?.type === ContentType.FOOTER) {
        return (
          <footer className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </footer>
        );
      }
      ...
      if (content?.type === ContentType.SECTION) {
        return (
          <section className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </section>
        );
      }
      ...
      if (content?.type === ContentType.ARTICLE) {
        return (
          <article className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </article>
        );
      }
      ...
      if (content?.type === ContentType.STRONG) {
        return (
          <strong className={this.prepareClassName(content.classes, context)}>
            {this.render(content?.body, context)}
          </strong>
        );
      }
      ...
      if (content?.type === ContentType.A) {
        return (
          <a
            className={this.prepareClassName(content.classes, context)}
            href={this.prepareAHref(
              (content as unknown as { href?: string }).href,
              context,
            )}
          >
            {this.render(content?.body, context)}
    ...
    if (isBaseContent(content)) {
      if (content?.type === ContentType.HR) {
        return (
          <hr className={this.prepareClassName(content.classes, context)} />
        );
      }

      if (content?.type === ContentType.BR) {
        return (
          <br className={this.prepareClassName(content.classes, context)} />
        );
      }
      ...
      if (content?.type === ContentType.IMG) {
        return (
          <img
            className={this.prepareClassName(content.classes, context)}
            alt={this.prepareImgAlt(
              (content as unknown as { alt?: string }).alt,
              context,
            )}
            src={this.prepareImgSrc(
              (content as unknown as { src?: string }).src,
              context,
            )}
          />
        );
    ...
    if (component) {
      return (
        <>
          {this.render(
            component,
            context.createComponentContext(component, content),
          )}
        </>
      );
    }
  ...
  private static _getCardProps(
    ...
    return {
      ...
      ...(value?.details !== undefined
        ? { details: this.render(value?.details, context) }
        : {}),
  ...
  private static _getNavigateButtonsProps(
    value: NavigateButtonsContent,
  ): NavigateButtonsProps {
    return {
      ...{ backUrl: value.backUrl },
      ...{ forwardUrl: value.forwardUrl },
      ...(value?.alterBack !== undefined
        ? { alterBack: value?.alterBack }
        : {}),
  ...
  private static _getStatusBarProps(
  ...
  private static _getLayoutProps(
    value: LayoutContent,
    context: RendererContext,
  ): LayoutContentProps {
    return {
      ...(value?.showNavbar !== undefined
        ? { showNavbar: parseBoolean(value?.showNavbar) }
        : {}),
      ...(value?.showHeader !== undefined
        ? { showHeader: parseBoolean(value?.showHeader) }
        : {}),
      ...(value?.showFooter !== undefined
        ? { showFooter: parseBoolean(value?.showFooter) }
        : {}),
      ...(value?.showPublicFooter !== undefined
        ? { showPublicFooter: parseBoolean(value?.showPublicFooter) }
        : {}),
      ...(value?.navbarTitle !== undefined
        ? { navbarTitle: this.render(value?.navbarTitle, context) }
        : {}),
