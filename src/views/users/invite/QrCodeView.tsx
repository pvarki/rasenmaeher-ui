...
Näytä taistelijallesi QR-koodia
Taistelija pääsee kirjautumissivulle
Hyväksy taistelijasi kirjautuminen 

Hyväksy taistelija kuvaamalla tämän näytöltä QR-koodi, tai hyväksymällä se “Hae koodilla” -valikosta        </span>
    </div>
  )
}