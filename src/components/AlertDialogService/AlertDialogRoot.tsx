...
export function AlertDialogRoot() {
  ...
  return (
    <AlertDialog.Root open={open} onOpenChange={closeDialog}>
      <AlertDialog.Portal>
        <AlertDialog.Overlay className="bg-black opacity-60 fixed inset-0" />
        <AlertDialog.Content className="fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-backgroundLight p-[25px] shadow-[0px_10px_38px_-10px_hsl(206_22%_7%_/_35%),_0px_10px_20px_-15px_hsl(206_22%_7%_/_20%)] focus:outline-none">
          ...
          <div className="flex justify-end gap-[25px]">
            ...
            <AlertDialog.Action asChild>
              <Button
                variant={{ color: props?.confirmColor ?? "error" }}
