  ...
  return (
    <div className="fixed bottom-2 left-0 right-0 flex justify-center">
      <section className="items-start rounded bg-zinc-800 flex w-[370px] max-w-full gap-2.5 mt-24 p-2.5 max-md:justify-center">
        <button
          className={`transform transition-transform duration-200 justify-center items-center rounded ${BackClicked ? "scale-95" : "scale-100"} ${BackClicked ? "bg-blue-500" : "bg-zinc-800"} self-stretch flex w-[163px] max-w-full flex-col px-5 py-2.5`}
        ...
        <button
          className={`transform transition-transform duration-200 bg-blue-900 justify-center items-center ${ContinueClicked ? "scale-95" : "scale-100"} self-stretch flex w-[163px] max-w-full flex-col px-5 py-2.5`}
