...
async function approveUser({callsign, approvalCode }: {callsign: string, approvalCode: string}) {
...
type useApproveUserOptions = UseMutationOptions<void, Error, {callsign: string, approvalCode: string}, unknown>
