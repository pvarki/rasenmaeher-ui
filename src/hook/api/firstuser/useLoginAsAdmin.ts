...
type UseCheckInviteCodeOptions = UseMutationOptions<string, Error, {callsign: string, code: string}, unknown>

async function loginAsAdmin({callsign, code}: {callsign: string, code: string}) {
